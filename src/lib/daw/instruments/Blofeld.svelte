<script>
  ...
  let ledColor = "#E4Ew5E7";

  onMount(() => {
    // setInterval(() => {
    //   ledColor = ledColor === "#E4E5E7" ? "#FF0000" : "#E4E5E7";
    // }, 1000);
  });
</script>

<aside class="mx-auto flex max-w-7xl flex-col">
  <div class="border-2 border-red-600 bg-white p-12">
    <div class="blofeld rounded-lg border border-gray-300 bg-gradient-to-b from-[#E9EAEC] to-[#E9EAEC] shadow-xl">
      <div class="flex flex-row items-start justify-evenly">
        <span class="p-1">
          <PowerIcon size="16" class="text-black" />
        </span>
      ...
      <div class="flex flex-row gap-3 px-6 pb-12 pt-6">
        <!-- Left side -->
        <div class="w-5/12">
          <!-- Display Area -->
          <div class="flex flex-row gap-6 rounded bg-[#4E5E65] p-3">
            <div class="flex w-20 flex-col items-start justify-evenly gap-1">
              ...
              <div class="inline-flex w-auto flex-col items-center gap-1">
                <button class="tiny-button"></button>
                <span class="block text-xs font-semibold leading-none">Play</span>
              </div>
            </div>

            <div class="lcd-screen grid w-64 grid-cols-2 gap-x-3 gap-y-1 p-2">
              <div class="col-span-full">
                <div class="block w-full border-b-2 border-black">Play Sound</div>
              </div>
              <div class="col-span-1">
                <span>A001</span>
                <span class="block text-lg font-bold">With Love</span>
              </div>
              <div class="col-span-1">
                <span>Category: Pad</span>
                <span class="block text-center text-lg font-bold">WMF</span>
              </div>
              ...
              <div class="col-span-1">
                <span class="block text-center">A</span>
              </div>
              <div class="col-span-1">
                ...
                <div class="flex flex-row items-start">
                  <div class="flex w-16 shrink-0 flex-row">
                    <div class="relative inline-flex w-full flex-col">
                      <button class="tiny-button"></button>
                      <span class="pill -mb-2 mt-2 text-left text-xs font-semibold leading-none">Shift</span>
                    </div>
                  </div>
...
<style>
  ...
  .tiny-button {
    @apply ml-3 block h-5 w-10 rounded-[150%] bg-black;
  ...
  .lcd-screen::before {
    ...
    width: 100%;
    height: 100%;
    background-image: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="3" height="3"><rect width="1" height="1" fill="0e1737" opacity="1"/></svg>');
    background-color: rgba(44, 57, 44, 0.25);
    opacity: 0.5;
    pointer-events: none;
  }
